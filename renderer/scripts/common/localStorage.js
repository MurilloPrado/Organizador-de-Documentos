...
export const KEY = { servicos:'app.servicos', servicosAdicionais:'app.servicosAdicionais', taxas:'app.taxas', certidoes:'app.certidoes', despesas: 'app.despesas', arquivos: 'app.arquivos' };
